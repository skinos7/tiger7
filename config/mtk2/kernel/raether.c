...
void rt305x_esw_init(void)
{
	 ...
	 */
        ...
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x0090) = 0x00007f7f;
        ...
        /* modify by dimmalex for part the p0/p4 */
        #ifdef CONFIG_WAN_AT_P4
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x40) = 0x1001;
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x44) = 0x1001;
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x48) = 0x1002;
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x70) = 0xffff506f;
        printk( "WAN at the P4\n" );
        #endif
        #ifdef CONFIG_WAN_AT_P0
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x40) = 0x1002;
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x44) = 0x1001;
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x48) = 0x1001;
        *(unsigned long *)(RALINK_ETH_SW_BASE+0x70) = 0xffff417e;
        printk( "WAN at the P0\n" );
        #endif
...
void setup_external_gsw(void)
{
	...
	*(volatile u_long *)(SYSCFG1) &= ~(0x3 << 12);
	...
	// comment by qingcheng for no opeation gpio
	//*(volatile u_long *)(RALINK_SYSCTL_BASE + 0x60) &= ~(0x1 << 15);
...
void setup_internal_gsw(void)
{
	...
	*(volatile u_long *)(SYSCFG1) &= ~(0x3 << 14);
    ...
    // comment by dimmalex for the RGMII2 RX cannot be gpio 
