...
#include "../../../../../net/nat/hw_nat/ra_nat.h"
	//if skb is cloed and can't support hw nat, goto netif_rx
...
// add by qingcheng 2022.01.24 mult packet can't use hw nat 
#if defined(CONFIG_RA_HW_NAT_NIC_USB)
	if (!(info->flags & FLAG_MULTI_PACKET) 
					&& ra_sw_nat_hook_tx!= NULL 
					&& skb)  
		ra_sw_nat_hook_tx(skb, 777);
#endif
